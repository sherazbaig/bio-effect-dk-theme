...
const Paths = require('@we-make-websites/canvas-design-tools/canvas-design-tools/helpers/paths')
...
const timingOrdinals = ['quickest', 'quicker', 'quick', 'normal', 'slow', 'slower', 'slowest', 'loading', 'skeleton', 'message']
...
module.exports = {
   ...
   * - 'fontSize' included so text classes can find font-size property.
   */
  variablesByType: [
    'borderRadius',
    'borderWidth',
   ...
   * - Names are converted to handles, so use handles in the below list.
   * - 'paragraphIndent' included so text classes can find text-indent property.
   */
  variablesByName: [
    'breakpoint',
    'easing',
  ...
  /**
   * Set layout names to include.
   * - Names are converted to handles, so use handles in the below list.
   * - Exclude breakpoint from name, e.g. use 'margin', not 'mobile-margin'.
   */
  layoutNames: [
    'column',
    'gutter',
   ...
   * - Layout units are not used for columns.
   * ---------------------------------------------------------------------------
   */
  ...
  sorting: {
    ...
    'font-weight': ['thin', 'extra-light', 'ultra-light', 'light', 'book', 'normal', 'regular', 'medium', 'demi-bold', 'demibold', 'semi bold', 'semi-bold', 'semibold', 'bold', 'extra-bold', 'ultra-bold', 'black', 'heavy'],
    icon: sizeOrdinals,
    layer: ['base', 'flat', 'raised', 'heightened', 'sticky', 'window overlay', 'window-overlay', 'overlay', 'temporary'],
    layout: screenOrdinals.map((ordinal) => `layout-${ordinal}`),
    ...
    typography: {
      ...
      body: sizeOrdinalsReverse,
      other: sizeOrdinalsReverse,
    },
  },
