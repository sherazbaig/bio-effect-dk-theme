/**
 * Plugin: Basis debug end plugin
 * -----------------------------------------------------------------------------
 * Outputs messages at the end of each Webpack stage.
 *
 */
 ...
 * Set variables.
 */
const pluginName = 'BasisDebugEnd'

/**
 * Tap into hooks and add functionality.
 */
module.exports = class BasisDebugEnd {
  apply(compiler) {
    ...
    compiler.hooks.thisCompilation.tap(pluginName, (compilation) => {
      debug('Hook', 'thisCompilation end\n', 'bgWhite')
